...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { activity_id: @lineitem.activity_id, cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, quantity: @lineitem.quantity }
    end
  ...
  test "should update lineitem" do
    patch :update, id: @lineitem, lineitem: { activity_id: @lineitem.activity_id, cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, quantity: @lineitem.quantity }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
